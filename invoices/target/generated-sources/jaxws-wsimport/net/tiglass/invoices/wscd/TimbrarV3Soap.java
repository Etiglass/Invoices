...
public interface TimbrarV3Soap {
    ...
    @RequestWrapper(localName = "getTimbre", targetNamespace = "http://localhost/Timbrar/", className = "net.tiglass.invoices.wscd.GetTimbre")
    @ResponseWrapper(localName = "getTimbreResponse", targetNamespace = "http://localhost/Timbrar/", className = "net.tiglass.invoices.wscd.GetTimbreResponse")
    ...
    @RequestWrapper(localName = "getTimbreCFDI", targetNamespace = "http://localhost/Timbrar/", className = "net.tiglass.invoices.wscd.GetTimbreCFDI")
    @ResponseWrapper(localName = "getTimbreCFDIResponse", targetNamespace = "http://localhost/Timbrar/", className = "net.tiglass.invoices.wscd.GetTimbreCFDIResponse")
    ...
    @RequestWrapper(localName = "getTimbresZIP", targetNamespace = "http://localhost/Timbrar/", className = "net.tiglass.invoices.wscd.GetTimbresZIP")
    @ResponseWrapper(localName = "getTimbresZIPResponse", targetNamespace = "http://localhost/Timbrar/", className = "net.tiglass.invoices.wscd.GetTimbresZIPResponse")
